        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(
                		...
                		"/error","/test500","/test404","/preliminaryPPR15","/testppr15","/saveDraftPPR15","/getVillagesByProject1","/getMicroWatershedsByProject1","/getDraftsPPR15","/getDraftsPPR15", "/updatePPR15","/deletePreliminaryPPR15", "/viewPPR", "/checkTransPPRExists", "/forwardViewPPR", "/newMenu", "/saveMenu", "/mainmenu", "/editMenu", "/deleteMenu", "/fetchMenu",
                        ...
                        "/pprEmploymentGeneration", "/getProjectsByDistrictEmployment", "/getMicroWatershedsByProjectEmployment", "/getVillagesByProjectEmployment", "/getEmploymentVillageStatus", "/getEmploymentGenerationByDistrict", "/savePPREmployment", "/updatePPREmployment", "/deletePPREmployment", "/completePPREmployment", "/pprCropOutcomes", "/getUsedCropsByPpr", "/savecropRelatedOutcome", "/getCropOutcomesByDistrict", "/updateCropOutcome", "/completeCropOutcome", "/deleteCropOutcome", "/areaCoveredUnderWP/**",
                        "/checkDistrictCompleted", "/nextProjectName", "/rajectAndConfirm","/modifyPprTransaction", "/pprRequestDolrApproval", "/rejPprReqForAprov", "/referBackPprReqForAprov", "/approvePprReqForAprov", "/viewPprRequest", "/stWisePprTransactionStatus", "/newUserActiveDelete", "/slnausersrch", "/activatePiaUser", "/userRoleMap", "/userRoleMap/**", "/deleteUser", "/deactivateUser", "/activateExistingUser", "/extendSession",
